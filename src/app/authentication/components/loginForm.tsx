...
function LoginForm() {
        ...
        if (session) {
          ...
          try {
            ...
            if (userResponse.ok) {
              ...
              if (usuario) {
                console.log('👤 Usuario encontrado, redirigiendo a panel...')
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-pink-100 to-indigo-800">
